...
- WP-dream-filtered-input-budget: in native Codex sessions, use a fresh native Codex subagent for independent adversarial review; the owner clarified that `gptsol` names the historical Claude Code transport, not an exclusive reviewer requirement. Preserve the review and evidence contract across transports.
