...
| [0042](0042-machine-run-red-proofs.md) | RED evidence for an acceptance criterion is machine-run from a committed declaration, in its own lane, against a disposable copy | Proposed — awaiting owner signature |
