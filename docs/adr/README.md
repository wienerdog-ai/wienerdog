...
| [0039](0039-session-start-injects-only-what-the-block-lacks.md) | The SessionStart hook injects the digest only when the managed block does not already carry it | Proposed |
