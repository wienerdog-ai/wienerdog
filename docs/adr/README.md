...
| [0039](0039-managed-block-is-a-reference-not-a-copy.md) | ⚠ NUMBER COLLISION — the fork and upstream each signed a different ADR-0039 on 2026-08-30; owner disposition pending. The managed block is a reference, not a copy — no unattended job read-modify-writes a file Wienerdog does not own | Accepted — OWNER-SIGNED 2026-08-30 (collision: awaiting renumber/supersede ruling) |
