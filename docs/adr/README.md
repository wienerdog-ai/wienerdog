...
| [0041](0041-real-scheduler-mutation-is-opt-in.md) | A real OS-scheduler mutation is permitted only from the home it belongs to; the default is refuse | Proposed (inverts 0018 decision 2's opt-out guard; awaits owner signature) |
