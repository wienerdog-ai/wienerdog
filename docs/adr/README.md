...
| [0004](0004-no-daemon-invariant.md) | No-daemon invariant ("Wienerdog is just files") | Accepted — **Amendment 1 (hook clause, 2026-08-30) is PROPOSED and pending the owner's signature; the ratified Decision stands until then** |
