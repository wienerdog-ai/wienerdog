...
| [0038](0038-untrusted-manifest-fields-narrow-deletion-only.md) | An untrusted manifest field may only narrow a deletion, never widen one | **Proposed — awaiting owner signature** |
