...
**And three APPLIED mirrors, registered 2026-07-28 in round 4 after a review found
this list claiming "there are no other mirrors" while three cells of the same spec
applied a clause to a specific row.** They are mirrors in the ordinary sense and
they move with Table A:
...
That is the complete list — five mirrors, two summary and three applied. It was
wrong once by omission, so it is stated as an enumeration a reader can check against
the spec rather than as a closing assertion. It moves in the same pass as Table A.
