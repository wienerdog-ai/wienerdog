...
| [WP-140](WP-140-cal-add-event-rename.md) | Rename `cal draft-event` → `cal add-event` behind a calendar-write grant + credential (audit A2) | M7 | sonnet | Ready | WP-138, WP-139 |
| [WP-141](WP-141-broker-runjob-wiring.md) | Wire the broker into the routine runtime — broker-mcp.json seam, trusted launch descriptor, MCP tool allowlist, read-only vault snapshot, functional routine skills (audit A2) | M7 | opus | Ready | WP-137, WP-138, WP-139 |
| [WP-142](WP-142-broker-containment-harness.md) | Broker containment proof — end-to-end run-job poisoned-email E2E + exact-verb/grant/credential negatives (audit A2) | M7 | opus | Ready | WP-140, WP-141 |
| [WP-143](WP-143-a2-broker-docs.md) | A2 documentation — honest broker claims, THREAT-MODEL, GLOSSARY, gws-broker runbook, testing-mode 7-day expiry limitation (audit A2) | M7 | sonnet | Ready | WP-136, WP-137, WP-138, WP-139, WP-140, WP-141, WP-142 |
