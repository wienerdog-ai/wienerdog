...
| DENY | `WARP.md` | `warp.md` | Warp project rules; still fully supported and takes priority over `AGENTS.md` in the same directory. **Re-verified 2026-09-26:** the cited page moved (two redirects) to the URL below; content unchanged | https://docs.warp.dev/agents/capabilities/rules/ | @DATE@ |
