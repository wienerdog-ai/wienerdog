...
- [ ] **Table T** mirrors — registered in the pass that created it, because
      ...
      **What each instance was, which is this spec's own history and not the ADR's:**
      ...
      stays correct here and is permitted by ADR-0036's Table A row A2.** Nothing
