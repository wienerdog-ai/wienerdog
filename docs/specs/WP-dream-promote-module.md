...
- [ ] **Table Q — the EP2 result, and this family's share of the quarantine
      ...
      **no surface may carry the REDACTION ACCOUNTING as loose fields beside a
      ...
      AND WHEN, which is row Q9's rule applied to the OTHER SHAPE THAT CARRIES
      ONE PARTY'S FACTS TO ANOTHER — **not to every field this family adds, a
...
- **The EP2 gate's DURABLE quarantine lifecycle** — the retention prune of
  ...
  **The narrowing has exactly one exception, and it is authorized rather than
