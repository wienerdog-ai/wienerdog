...
**Eleven declarations in one file, over ten criteria — criterion 14 carries two,
because round 2's defect and round 3's are different failures of the same rule.
Seven carry a pre-measurable anchor and four mutate code this package authors**
...
- [ ] **Deliverables-table cells that restate a path or rule** — the
      ...
      **X1**/**X2**/**X4**/**X9**/**X10**/**X11**/**X12**/**X13**/**X15**;
