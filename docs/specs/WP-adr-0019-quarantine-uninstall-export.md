...
**Sixteen declarations in one file, over eleven criteria — criterion 14 carries
three, criterion 18 carries three, criterion 1 carries three, and criteria 1 and 9
share round 11's alias declaration while criteria 1 and 14 share round 12's. Nine
carry a pre-measurable anchor and seven mutate code this package authors**
...
- [ ] **Deliverables-table cells that restate a path or rule** — the
      ...
      **X1**/**X2**/**X4**/**X9**/**X10**/**X11**/**X12**/**X13**/**X15**/**X16**/**X17**/**X18**/**X19**
      and Table **V**;
...
- [ ] **Acceptance criteria that assert its facts** — criterion 1 asserts Table X
      rows **X1**/**X4**/**X18**/**X19**; criterion 2 asserts Table X row **X1**'s
...
6. **DISPATCH PRECONDITION.** (a) **The design gate is OPEN.** This spec was
   ...
   **CONVERGENCE NOTE — THE DELETION SURFACE IS CLOSED (round 12).** Twelve rounds
   ...
   replay kinds, `vendored-tree` and `copied-skill`; and **(6)** the core removal at
   `:1151-1170`, which is pre-existing, non-recursive and unchanged. **Every one of
   (1)–(5) is gated by Table X row X16's symmetric containment check over Table X
   row X17's anchors. No site is exempt, and no table lists one.** Resolution
