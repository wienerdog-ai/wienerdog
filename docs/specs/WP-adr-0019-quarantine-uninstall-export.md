...
**Eighteen declarations in one file, over eleven criteria — criterion 1 carries
four, criterion 18 four, criterion 14 three; criteria 1 and 9 share round 11's
alias declaration and criteria 1 and 14 share round 12's. Ten carry a
pre-measurable anchor and eight mutate code this package authors**
...
- [ ] **Acceptance criteria that assert its facts** — criterion 1 asserts Table X
      ...
      **W9**; criterion 13 asserts the refusal's idempotence; criterion **14**
      ...
      outcomes and **X20**, Table **V** and Table Y row **Y6**; criterion 19
      asserts Table B
