...
**Seventeen declarations in one file, over eleven criteria — criterion 18 carries
four, criterion 14 three, criterion 1 three; criteria 1 and 9 share round 11's
alias declaration and criteria 1 and 14 share round 12's. Ten carry a
pre-measurable anchor and seven mutate code this package authors**
...
- [ ] **Deliverables-table cells that restate a path or rule** — the
      ...
      **X1**/**X2**/**X4**/**X9**/**X10**/**X11**/**X12**/**X13**/**X15**/**X16**/**X17**/**X18**/**X19**/**X20**
      and Table **V**;
