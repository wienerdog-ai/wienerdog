...
**Thirteen declarations in one file, over eleven criteria — criterion 14 carries
two (round 2's defect and round 3's are different failures of one rule) and
criterion 18 carries two (round 8's from-below hole and round 9's from-above one).
Nine carry a pre-measurable anchor and four mutate code this package authors**
...
- [ ] **Deliverables-table cells that restate a path or rule** — the
      ...
      **X1**/**X2**/**X4**/**X9**/**X10**/**X11**/**X12**/**X13**/**X15**/**X16**
      and Table **V**;
...
- [ ] **Acceptance criteria that assert its facts** — criterion 1 asserts Table X
      ...
      **W9**; criterion 13 asserts the refusal's idempotence; criterion **14**
      ...
      asserts Table X row **X16**'s two halves, Table **V** and Table Y row **Y6**; criterion 19
      asserts Table B
