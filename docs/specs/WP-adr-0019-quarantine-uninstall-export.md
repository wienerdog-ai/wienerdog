...
**Twelve declarations in one file, over eleven criteria — criterion 14 carries two,
because round 2's defect and round 3's are different failures of the same rule.
Eight carry a pre-measurable anchor and four mutate code this package authors**
...
- [ ] **Acceptance criteria that assert its facts** — criterion 1 asserts Table X
      ...
      **W9**; criterion 13 asserts the refusal's idempotence; criterion **14**
      ...
      asserts Table X row **X16** and Table Y row **Y6**; criterion 19
      asserts Table B
