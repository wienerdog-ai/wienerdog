...
reddens `[SG-25]`; and the class (i) subtree anchor independently protects `[SG-33]`'s fixture,
so reverting the per-root hop budget does not redden it either. Both fixes and both regressions
