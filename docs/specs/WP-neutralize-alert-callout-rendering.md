...
- [ ] **No failing job loses its line.** For any `opts.alerts` holding `J` distinct
      ...
      An earlier wording called this "no failing job can disappear", which reads as
      the stronger guarantee this criterion does not make.
